  ...
  return (
    <div className="p-12 pt-0">
      ...
      <section className="flex flex-col lg:flex-row mt-5 md:mt-0">
        <div className="md:0-10 md:pl-0 mx-auto">
          <div className="flex gap-4">
            <img
              className="h-80 w-80 border rounded-md object-contain"
        ...
        {productData.content.reviews ? (
            ...
            {productData.content.reviews.top_review && (
                <div className="border p-5 rounded-lg mt-2">
                    ...
                    <div className="flex space-x-11 mb-2">
                        {[
                            ...Array.from({
                                length: Math.round(
            ...
            <div>
            <h3 className="font-bold text-2xl">Reviews
            </h3>

            <h4 className="text-lg italic">Not Review's yet</h4>
            </div>
        )}
      </section>
                ...
                {productData.content.specifications.map((specification) => (
                    <div key={specification.section_title}>
                        ...
                        {specification.items.map((items) => (
                            <div key={items.title} className="text-s,">
