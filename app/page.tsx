...
export default function Home() {
  return (
    <div className="p-10 pt-0 text-center md:text-left">
     <h1 className='text-3xl font-extralight mb-5'>Let's Build a Google Shopping Clone</h1>
    
    <h2 className='mb-5'>Get started by clicking on one of the example search items or typing in an item yourself above!</h2>
